...
public class InvisSeeConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(Component.literal("Other Entities: #" + String.format("%06X", InvisSeeConfig.entityColor & 0xFFFFFF)), btn -> {
            this.minecraft.setScreenAndShow(new ColorPickerScreen(this, "Other Entities", InvisSeeConfig.entityColor, picked -> {
        ...
        this.addRenderableWidget(Button.builder(Component.literal("Player Color: #" + String.format("%06X", InvisSeeConfig.playerColor & 0xFFFFFF)), btn -> {
            this.minecraft.setScreenAndShow(new ColorPickerScreen(this, "Player Color", InvisSeeConfig.playerColor, picked -> {
        ...
        this.addRenderableWidget(Button.builder(Component.literal("Reset Defaults"), btn -> {
            ...
            InvisSeeConfig.save();
            this.minecraft.setScreenAndShow(new InvisSeeConfigScreen(parent));
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.centeredText(this.font, this.title, this.width/2, 6, 0xFFFFFF);
        graphics.centeredText(this.font, Component.literal("Other=mobs, Player=players - O to open, G to toggle"), this.width/2, 18, 0xAAAAAA);
        ...
        graphics.outline(cx + 78, otherColorY + 4, 18, 12, 0xFF000000);
        graphics.fill(cx + 78, playerColorY + 4, cx + 96, playerColorY + 16, InvisSeeConfig.playerColor);
        graphics.outline(cx + 78, playerColorY + 4, 18, 12, 0xFF000000);
        graphics.text(this.font, Component.literal("Range:"), this.width/2 - 100, rangeEdit.getY() - 10, 0xAAAAAA);
        graphics.text(this.font, Component.literal("Line Width:"), this.width/2 - 100, lineWidthEdit.getY() - 10, 0xAAAAAA);
